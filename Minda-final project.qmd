...
wave_definitions <- tibble(
  ...
  start_date = as.Date(c("2020-03-01","2020-10-01","2021-07-01","2021-12-01","2022-11-01","2023-10-01")),
  end_date   = as.Date(c("2020-06-01","2021-03-01","2021-10-01","2022-03-01","2023-03-01","2024-12-01"))
)
...
ggplot(combined_data, aes(x = date, y = value, color = wave)) +
